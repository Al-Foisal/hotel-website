...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    public function setRequiredInfo(array $info)
    {
        ...
        $this->data['product_category'] = 'Category'; // string (50)	Mandatory - Mention the product category. It is a open field. Example - clothing,shoes,watches,gift,healthcare, jewellery,top up,toys,baby care,pants,laptop,donation,etc
    ...
    public function setAdditionalInfo(array $info)
    {
        ...
        $this->data['customer_id'] = (isset($info['customer_id'])) ? $info['customer_id'] : null;
        $this->data['reservation_id'] = (isset($info['reservation_id'])) ? $info['reservation_id'] : null;
        $this->data['room_id'] = (isset($info['room_id'])) ? $info['room_id'] : null;
        $this->data['reservation_details_id'] = (isset($info['reservation_details_id'])) ? $info['reservation_details_id'] : null;
