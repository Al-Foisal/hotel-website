                ...
                <form action="{{route('saveMessage')}}" method="post">
                    ...
                    <div class="contactForm row y-gap-30 pt-60">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-input ">
                                <input type="text" required class="" name="phone">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-input ">
                                ...
                                <label class="lh-1 text-16 text-light-1" name="email">Email</label>
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-input ">
                                <textarea required class="border-1" rows="8" name="message"></textarea>
                                <label class="lh-1 ">Message*</label>
                            </div>

                        </div>
                        <div class="col-12">
                            <button class="button -md -type-2 w-1/1 bg-accent-2 -accent-1" type="submit">SEND YOUR MESSAGE</button>
                        </div>
                    </div>
                </form>
            </div>
